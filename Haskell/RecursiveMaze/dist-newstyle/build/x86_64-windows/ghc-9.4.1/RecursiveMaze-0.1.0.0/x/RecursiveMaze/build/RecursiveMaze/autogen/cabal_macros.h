...
/* package RecursiveMaze-0.1.0.0 */
#ifndef VERSION_RecursiveMaze
#define VERSION_RecursiveMaze "0.1.0.0"
#endif /* VERSION_RecursiveMaze */
#ifndef MIN_VERSION_RecursiveMaze
#define MIN_VERSION_RecursiveMaze(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_RecursiveMaze */
...
#define CURRENT_COMPONENT_ID "RecursiveMaze-0.1.0.0-inplace-RecursiveMaze"
